...
public class Menu_Buku extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu__buku);

        getSupportActionBar().setTitle("Menu_Buku");
...
//pemberian if dan else untuk aturan pemberian bonus
                ...
                if (total >=150000){
                    txtbonus.setText("Bonus : Gratis buku all item");
                } else if (total >=100000){
                    txtbonus.setText("Bonus : Tshirt budak sajak");
                } else  if (total >=50000){
                    txtbonus.setText("Bonus : Cd fiersa besari");
                } else {
